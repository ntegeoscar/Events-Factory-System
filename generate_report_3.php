...
$missing_sql = "SELECT i.item_name, i.serial_number, i.model, e.customer, e.event_name, e.responsible_person_name, 
...
// missings List Section
$pdf->SetFont('helvetica', 'B', 16);
$pdf->Cell(0, 10, "Missing Report", 0, 1, 'C');
...
// Output PDF
$pdf->Output("missing_report.pdf", "D");
